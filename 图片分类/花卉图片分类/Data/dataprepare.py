...
imagelabel_path = 'C:/Users/gst-0123/Desktop/Projects/中医诊断AI/图片分类/Data/imagelabels.mat'   #该地址为EXP1工程下的imagelabels.mat的相对地址
setid_path = 'C:/Users/gst-0123/Desktop/Projects/中医诊断AI/图片分类/Data/setid.mat'              #该地址为EXP1工程下的setid.mat的相对地址
pic_path = 'C:/Users/gst-0123/Desktop/Projects/中医诊断AI/图片分类/Data/jpg/'                  #该地址为EXP1工程下的源数据图片的相对地址
img_size = (224,224)
...
des_folder_train = "C:/Users/gst-0123/Desktop/Projects/中医诊断AI/图片分类/Result/train"            #该地址为新建的训练数据集文件夹的绝对地址
for tid in train:
    #打开图片并获取标签
...
des_folder_validation = "C:/Users/gst-0123/Desktop/Projects/中医诊断AI/图片分类/Result/valid"       #该地址为新建的验证数据集文件夹的绝对地址
...
des_folder_test = "C:/Users/gst-0123/Desktop/Projects/中医诊断AI/图片分类/Result/train"#该地址为新建的测试数据集文件夹的绝对地址
for tid in test:
    img = Image.open(flower_dir[tid])
    # print(flower_dir[tid])
    img = img.resize(img_size, Image.LANCZOS)
