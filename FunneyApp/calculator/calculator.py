...
class Calculator():
    tool_name = '简易计算器'
    def __init__(self, title='简易计算器', root_size=(320, 420), **kwargs):
        # 初始化主窗口
        ...
        # 参数初始化
        self.storage = []  # 存储操作数和操作符
        self.is_calculate = False  # 标记是否刚刚计算过
        self.max_show_len = kwargs.get('max_show_len', 18)  # 显示框最大长度
        self.current_show = tkinter.StringVar()  # 当前显示内容
